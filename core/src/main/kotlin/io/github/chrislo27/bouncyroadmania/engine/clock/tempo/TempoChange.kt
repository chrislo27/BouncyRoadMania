package io.github.chrislo27.bouncyroadmania.engine.clock.tempo
...
import io.github.chrislo27.bouncyroadmania.engine.clock.Tracker
...
class TempoChange(container: TempoChanges, beat: Float, val bpm: Float, val swing: Swing, width: Float)
    ...
    companion object {
        ...
        fun getFormattedText(bpm: Float): String = "♩=${ONE_DECIMAL_PLACE_FORMATTER.format(bpm)}"
    }
